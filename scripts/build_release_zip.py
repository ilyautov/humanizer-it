#!/usr/bin/env python3
"""Build the release ZIP for the humanizer-it skill package."""
...
SKILL_REL = Path("skills") / "humanizer-it"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build humanizer-it.zip for a GitHub Release.")
    parser.add_argument(
        "--output",
        default="dist/humanizer-it.zip",
        help="Output ZIP path. Default: dist/humanizer-it.zip",
    )
